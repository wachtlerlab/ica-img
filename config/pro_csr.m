%
Mode.comment = 'Protanop: S w/ M surround, M w/ M surround, je on & off';
...
DataParam.dataDim   = 4; %this is post filtering
DataParam.doFilter  = true;
DataParam.filter    = simpleFilter;
DataParam.filterFn  = 'filterCSRecProtanop';
DataParam.filterCS  = 1;
DataParam.doDebug   = true;
DataParam.doLog     = true;
DataParam.chanMap   = [49 17 50 18];
