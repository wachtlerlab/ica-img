...
main(int argc, char **argv)
{
  ...
  char *filename;
  int i, ndir;
  cube_matrix_t *dA, *A, *MA, *S, *Z, *mu, *beta, *sigma, *Zref, *X;
  mxArray *mxa;
  NAPair  *iter;
  NAPair a_map[] = {"dA", &dA, "A", &A, "MA", &MA, "S", &S, "mu", &mu, "beta", &beta, "sigma", &sigma, "Z", &Z, "Zref", &Zref, NULL,};
  double a, b, s;

  dA = A = MA = S = mu = beta = sigma = Z = NULL;
